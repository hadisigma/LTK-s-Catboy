...
function buildHelpEmbed() {
  return new EmbedBuilder()
    ...
    .addFields(
      ...
      {
        name: '/nickname [username] [nickname]',
        value: "Changes what name a member is displayed with.",
      },
      {
      ...
      },
      {
        ...
        value: 'Toggles a channel in/out of the automod whitelist - nothing gets deleted or timed out there. Run again on the same channel to undo.',
      },
      {
        name: '-$help',
