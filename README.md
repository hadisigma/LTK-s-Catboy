...
5. **OAuth2 → URL Generator**: check `bot` and `applications.commands` scopes. Under **Bot Permissions**, check at least: `Kick Members`, `Moderate Members`, `Manage Roles`, `Manage Channels`, `Send Messages`, `Read Message History`. Open the generated URL to invite the bot to your server.
